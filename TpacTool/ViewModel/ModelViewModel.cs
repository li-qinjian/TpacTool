    ...
    public class ModelViewModel : ViewModelBase
    {
        ...
        private void OnSelectAsset(AssetItem assetItem)
        {
            ...
            if (metamesh != null)
            {
                ...
                if (setBookMarks.Contains(metamesh.Name))
                {
                    IsMarked = true;
        ...
        private void Export()
        {
            ...
            DirectoryInfo curWorkDir = new DirectoryInfo(strWorkDir + "\\..\\AssetSources");
            if (!curWorkDir.Exists)
            {
        ...
        private void BookMark()
        {
            if ((bool)!_isMarked)
            {
                setBookMarks.Remove(Asset.Name);
                IsMarked = false;
                RaisePropertyChanged("IsMarked");
