                ...
                if (_shouldUpdate)
                {
                    ...
                    if (Meshes != null)
                    {
                        foreach (var mesh in Meshes)
                        {
                            ...
                            Material mat;
                            if (mesh.Material.TryGetItem(out mat) || mesh.SecondMaterial.TryGetItem(out mat))
                            {
                                if (mat != null && mat.Textures.TryGetValue(0, out var texRef) && texRef.TryGetItem(out var tex))
                                {
